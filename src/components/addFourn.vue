    ...
    <Dialog :maximizable="true" :visible="visible" @update:visible=" ()=>{
        ...
        <template #footer>
            <div class="flex">
                ...
                <div class="">
                    <Button label="Enregistrer" class="p-button-sm" icon="pi pi-check" @click="postFourn" :loading="isLoading" />
                </div>
            </div>
    ...
    methods:{
        async postFourn(){
            ...
            try {
                ...
                if(_d.status){
                    this.$emit('validate')
                    this.showNotif('success',`Ajout fournisseur`,`Fournisseur bien ajouté`)
                }else{
                    this.showNotif('error',`Ajout fournisseur`,_d.message)
                }
            } catch (e) {
