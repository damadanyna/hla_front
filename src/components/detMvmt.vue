                ...
                if(stk.length == 0){
                    ...
                    for (let i = 0; i < stk.length; i++) {
                        ...
                        if(e.depot_id == depot_id){
                            ...
                            if(this.mt.mvmt_action == 'entre'){
                                return (e.depot_code == 'M02')?`${e.stk_actuel} (${e.stk_actuel - mart.mart_qt})`:e.stk_actuel
                            }else if(this.mt.mvmt_action == 'sortie'){

                                if(this.mt.mvmt_type == 'transfert'){

                                    if(e.depot_id == this.mt.mvmt_depot_dest){
                                        return `${e.stk_actuel} (${e.stk_actuel - mart.mart_qt})`
                                    }else if(e.depot_id == this.mt.mvmt_depot_exp){
                                        return `${e.stk_actuel} (${e.stk_actuel + mart.mart_qt})`
                                    }
