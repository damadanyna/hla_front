...
<template>
    <div class="text-sm p-2">
        ...
        <div class="flex border-b py-2 sticky  bg-white" style="top:58px">
            ...
            <Button v-if="nb_not_validate > 0 || nb_not_validate_avance > 0" class="p-button-sm ml-2" @click="on_saisie_encaisse = true" >
                <span class="flex align-items-center">
                    <span class="material-symbols-outlined" style="font-size:1rem"> point_of_sale </span>
                    <span class="ml-2"> Encaissement </span>
                    <span v-if="nb_not_validate > 0 || nb_not_validate_avance > 0" class="ml-2 border-round font-bold bg-red-500 text-white px-2 text-center flex justify-content-center align-items-center text-mg"> {{ nb_not_validate + nb_not_validate_avance }} </span>
                </span>
            </Button>
        ...
        async getListEncaissement(){
            try {
                ...
                if(d.status){
                    ...
                    this.nb_not_validate_avance = d.nb_not_validate_avance
                }else{
