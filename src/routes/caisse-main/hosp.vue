    ...
    methods:{
        ...
        async getListEncaissement(a){
            try {
                ...
                const r = await this.$http.get('api/caisse/main/hosp',{
        ...
        async exportOnPDF(){
            try {       
                this.on_export = true 
                const r = await this.$http('api/caisse/main/hosp',{
                    params:{
        ...
        async exportOnExcel(){
            try {       
                ...
                if(d.status){
                    ...
                    if(dd.status){
                        this.showNotif('success','Exportation Hospitalisation ','Hospitalisation bien exportées')
                    }
